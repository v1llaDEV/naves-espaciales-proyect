...
public class NaveEspacialController {
    ...
    @PostMapping
    public NaveEspacialResponse createNaveEspacial(@RequestBody NaveEspacialRequest naveEspacial) {
        return naveEspacialService.createNaveEspacial(naveEspacial);
    }

    @PutMapping("/{id}")
    public NaveEspacialResponse updateNaveEspacial(@PathVariable Long id, @RequestBody  NaveEspacialRequest naveEspacial) {
